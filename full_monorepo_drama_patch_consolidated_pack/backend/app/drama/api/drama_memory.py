...
@router.get("/characters/{character_id}", response_model=List[DramaMemoryRead])
...
@router.get("/characters/{character_id}/recall", response_model=List[DramaMemoryRead])
...
@router.get("/{memory_id}", response_model=DramaMemoryRead)
